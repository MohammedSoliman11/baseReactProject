...
function getServiceOrderForm() {
  // ServiceOrder Form Function for registration
  console.log("getServiceOrderForm");
}
...
// "طلب خدمة" Form
const ServiceForm = () => (
  <form className="mediumFont" onSubmit={getServiceOrderForm}>
    <div className="mb-3">
      <div className="input-container">
        <label className="input-label">الاسم الثلاثي</label>
        <span className="required">*</span>
